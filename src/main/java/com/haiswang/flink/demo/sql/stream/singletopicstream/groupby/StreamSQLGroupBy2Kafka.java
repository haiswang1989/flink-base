 ...
 */
public class StreamSQLGroupBy2Kafka {
    ...
    public static void main(String[] args) throws Exception {
        ...
        tableEnv.registerTableSink("result_sink_table", retractStreamKafkaSink);
        
        //上边多定义了一个'c1'字段,类型是String,用于存储datastream中流的类型的,这边的SQL中就要添加一个"占位"字段
        tableEnv.sqlUpdate("insert into result_sink_table select id, name, count(1) as cnt, 'true' from source_table group by id,name");
